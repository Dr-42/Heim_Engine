...
uint32_t heim_shader_get_program(const char* vert_source_path, const char* frag_source_path, HeimLogger* logger, HeimMemory* memory){
    ...
    heim_shader_get_source(vert_source_path, vert_shader_source, vert_shader_size, logger, memory);
    ...
    heim_shader_get_source(frag_source_path, frag_shader_source, frag_shader_size, logger, memory);
